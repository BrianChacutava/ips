...
<div class="card">
    <div class="card-header"><strong>Criar</strong><small> Fatura</small>
    ...
    <div class="card-body card-block">
        ...
        <form action="{{ route('fatura.store') }}">
            {{-- @else
...
{{-- 
                ...
                <div class="col col-sm-4"><label for="vat" class=" form-control-label"><small>Data</small></label>
                    ...
                    <input type="text" id="vat" placeholder="Digite o nuite"
                        class="input-sm form-control-sm form-control" value="{{ $fatura->created_at }} " disabled="">
                    @endif
                    ...
                    <div class="card">
                        ...
                        <div class="table-stats order-table ov-h" id="test">
                            <table class="table " id="target">
                                ...
                                <tbody>
                                    {{--  @dd($cotacao->artigos)  --}}
                                    {{--  @forelse ($fatura->artigos as $artigo)
                                    <tr>
            ...
            <form action="{{ route('fatura.store', $faturas) }}" class="col col-sm-12 form-row">
...
<div class="modal fade" id="smallmodal2" tabindex="-1" role="dialog" aria-labelledby="smallmodalLabel"
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('fatura.add_artigo', ['fatura' => $fatura]) }}">

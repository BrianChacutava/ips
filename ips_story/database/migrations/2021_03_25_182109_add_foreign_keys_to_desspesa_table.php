...
class AddForeignKeysToDesspesaTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('desspesa', function (Blueprint $table) {
            ...
            $table->foreign('funcionario_id', 'fk_desspesa_funcionario1')->references('id')->on('funcionario')->onUpdate('NO ACTION')->onDelete('NO ACTION');
    ...
    public function down()
    {
        Schema::table('desspesa', function (Blueprint $table) {
            ...
            $table->dropForeign('fk_desspesa_funcionario1');
